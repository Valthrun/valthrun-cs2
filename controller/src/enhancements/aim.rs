    ...
    fn update(&mut self, ctx: &crate::UpdateContext) -> anyhow::Result<()> {
        ...
        let mouse_sensitivity = {
            ...
            if sens != 0.0 {
                ...
                self.mouse_sensitivity.fl_value_default()?.max(1.0)
            }
        };
        ...
        // When shooting stops, smoothly reset tracking to current punch angle state
        // to prevent sudden jumps when punch angle hasn't fully decayed
